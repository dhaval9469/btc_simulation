                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                "H30OPV",
                                style: textMontserrat(context, fontWeight: FontWeight.bold, fontSize: context.sp(18)),
                              ),
                            ],
                          ),
                        ),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    FaIcon(FontAwesomeIcons.copy, color: AppColor.subText, size: context.sp(15)),
                                    SizedBox(width: context.sp(10)),
                                    Text(
                                      "Copy Code",
                                      style: subTextMontserrat(context,fontSize: context.sp(15),fontWeight: FontWeight.w600),
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    FaIcon(FontAwesomeIcons.slideshare, color: AppColor.subText, size: context.sp(15)),
                                    SizedBox(width: context.sp(10)),
                                    Text(
                                      "Share",
                                      style: subTextMontserrat(context,fontSize: context.sp(15),fontWeight: FontWeight.w600),
